...
const PREVIEWS = [
  { name: 'NFT Mint Page Pro', cat: 'Mint Page', price: '$49', badge: 'Popular' },
  { name: 'Buglist Whitelist System', cat: 'Community', price: '$79', badge: 'New' },
  { name: 'Web3 Dev Portfolio', cat: 'Landing Page', price: '$89', badge: null },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            ...
            <h2 className="font-mono text-3xl md:text-4xl font-medium text-white mt-3">Ready-made Web3 starters</h2>
            <p className="text-white/40 text-sm mt-3 max-w-md">Production-ready templates. Buy once, deploy in minutes. Full source code included.</p>
          </div>
          <Link href="/templates"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {PREVIEWS.map((t, i) => (
            <Link href="/templates" key={t.name}
              ...
              <div className="h-36 bg-dark-200 border-b border-dark-300 relative flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="font-mono text-sm text-white/15">{t.cat}</div>
                </div>
                <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                  <span className="font-mono text-xs text-neon/50 bg-dark/70 border border-dark-400 px-2 py-0.5 rounded">{t.cat}</span>
                  {t.badge && (
